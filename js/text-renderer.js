...
function setupUI() {
    ...
    document.getElementById('dataFileInput').addEventListener('change', handleDataLoad);
    ...
    letterSpacingSlider.addEventListener('input', (e) => {
        ...
        document.getElementById('letterSpacingValue').textContent = config.letterSpacing;
    });
...
function generateTextSVG(text) {
    ...
    const totalWidth = maxLineLength * (config.fontSize * 0.6 + config.letterSpacing) + 100;
...
function copySVGToClipboard() {
    ...
    navigator.clipboard.writeText(renderedSVG).then(() => {
