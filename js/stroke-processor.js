...
class StrokeProcessor {
     ...
     */
    static normalize(strokes, bounds) {
    ...
    static applyVariation(strokes, config = {}) {
        ...
        const rotation = (Math.random() - 0.5) * 2 * rotationRange * (Math.PI / 180);
    ...
    static calculateMetrics(stroke) {
        ...
        const duration = stroke.points[stroke.points.length - 1].timestamp - stroke.points[0].timestamp;
